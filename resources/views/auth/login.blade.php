...
.alert{padding:12px 16px;border:1px solid;margin-bottom:24px;font-size:13px;border-radius:0}
...
.remember{display:flex;align-items:center;gap:10px;font-size:13px;color:#888;margin-bottom:4px}
...
<div class="auth-box">
  ...
  <h1>Kirish</h1>
  <p class="sub">Akkauntingizga kiring</p>
  ...
  <form method="POST" action="/login">
    ...
    <div class="field">
      ...
      <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="+998 XX XXX XX XX" required autofocus>
    </div>
    <div class="field">
      <label>Parol</label>
    ...
    <div class="remember">
      ...
      <label for="rem" style="letter-spacing:0;text-transform:none;margin:0;font-size:13px">Meni eslab qol</label>
    </div>
    <button type="submit" class="btn">Kirish <i class="fas fa-arrow-right"></i></button>
  </form>
  <div class="link-row">Akkauntingiz yo'qmi? <a href="/register">Ro'yxatdan o'tish</a></div>
</div>
</body>
</html>
